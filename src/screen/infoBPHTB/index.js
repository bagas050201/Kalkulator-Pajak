...
export default function InfoBPHTB ({ navigation }) {
        ...
        <View style={styles.container}>
                ...
                <ScrollView style={{}}>
                    <View style={{backgroundColor:'#FCDBD6',width:250,marginTop:20,borderColor:'#CC4F34',borderWidth:2,borderRadius:8,marginLeft:77}}>
                        <Text style={{fontSize:22,textAlign:'center',marginTop:14,marginBottom:14,marginLeft:1,color:'#CC4F34',fontWeight:'bold'}}>Apa itu BPHTB ?</Text>
                    </View>
                    <WebView
                        source={{
                        uri: 'https://bprd.jakarta.go.id/halaman/bea-perolehan-hak-atas-tanah-d',
                        }}
