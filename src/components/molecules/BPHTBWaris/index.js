...
export default function BPHTBWaris () {
    ...
    const hitungBPHTB = () => {
      ...
      if(!(luasTanah && luasBangunanSSPD && luasBangunanLapangan && NJOPBumi && NJOPBangunan && Transaksi)) 
      {
        ...
        Alert.alert("Mohon Masukan Data BPHTB Waris Secara Lengkap");
        return false;
      }
      else {
        ...
        <View style={styles.container}>
                ...
                <View style={{width:360,alignSelf: 'flex-start',backgroundColor:'white',marginLeft:25,marginBottom:10,marginTop:15,borderRadius:5,borderColor:'#485c77'}}>
                        <View style={{backgroundColor:'#6EE7B7',width:320,marginTop:15,borderColor:'#6EE7B7',borderWidth:2,borderRadius:5,marginLeft:18}}>
                            <Text style={{fontSize:20,textAlign:'center',marginTop:5,marginBottom:8,color:'white',fontWeight:'bold'}}>BPHTB WARIS</Text>
                        </View>
                        ...
                        <View style={{marginLeft:19,marginTop:13,marginRight:22,borderRadius:5,borderColor:'#6EE7B7',borderWidth:2}}>
                            ...
                            <View style={{height:225,backgroundColor:'#D1FAE5'}}>
                                ...
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>Luas Bangunan SSPD : <Text style={tailwind("bg-green-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowluasBangunanSSPD}</Text></Text>
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>Luas Bangunan Lapangan : <Text style={tailwind("bg-green-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowluasBangunanLapangan}</Text></Text>
                                ...
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>Harga Transaksi : <Text style={tailwind("bg-green-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowTransaksi}</Text></Text>
                            </View>
                        </View>
                        ...
                        <View style={{marginLeft:19,marginTop:13,marginRight:22,marginBottom:15,borderRadius:5,borderColor:'#F87171',borderWidth:2}}>
                            ...
                            <View style={{height:715,backgroundColor:'#FEE2E2'}}>
                                ...
                                <View style={{backgroundColor:'#34D399',width:280,marginTop:15,borderColor:'#34D399',borderWidth:2,borderRadius:5,marginLeft:18}}>
