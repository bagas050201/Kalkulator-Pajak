...
export default function BPHTBNormal () {
  ...
  const hitungBPHTB = () => {
    ...
    if(!(luasTanah && luasBangunanSSPD && luasBangunanLapangan && NJOPBumi && NJOPBangunan && Transaksi)) 
    {
      ...
      Alert.alert("Mohon Masukan Data BPHTB Normal Secara Lengkap");
      return false;
    }
    else {
      ...
      let bphtbSebelum = Math.round(npopkpSebelum * 0.05);
      let bphtbSesudah = Math.round(npopkpSesudah * 0.05);

      if (bphtbSesudah > bphtbSebelum) {
        bphtbAsli = Math.round(bphtbSesudah - bphtbSebelum);
        ...
        bphtbAsli = Math.round(bphtbSebelum - bphtbSesudah);
        let fixbphtbAsli = bphtbAsli.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.");
        setBPHTBResult(fixbphtbAsli);
    ...
    return (
        <View style={styles.container}>
                ...
                <View style={{width:360,alignSelf: 'flex-start',backgroundColor:'white',marginLeft:25,marginBottom:10,marginTop:15,borderRadius:5,borderColor:'#485c77'}}>
                        <View style={{backgroundColor:'#FCD34D',width:320,marginTop:15,borderColor:'#FCD34D',borderWidth:2,borderRadius:5,marginLeft:18}}>
                            <Text style={{fontSize:18,textAlign:'center',marginTop:5,marginBottom:8,color:'white',fontWeight:'bold'}}>BPHTB JUAL BELI, HAK BARU, LELANG</Text>
                        </View>
                        ...
                        <TextInput
                            ...
                            type="text"
                            keyboardType="numeric"
                            placeholder="Luas Bangunan pada SSPD-BPHTB"
                        ...
                        <View style={{marginLeft:19,marginTop:13,marginRight:22,borderRadius:5,borderColor:'#FCD34D',borderWidth:2}}>
                            ...
                            <View style={{height:225,backgroundColor:'#FEF3C7'}}>
                                
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>Luas Tanah : <Text style={tailwind("bg-yellow-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowluasTanah}</Text></Text>
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>Luas Bangunan SSPD : <Text style={tailwind("bg-yellow-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowluasBangunanSSPD}</Text></Text>
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>Luas Bangunan Lapangan : <Text style={tailwind("bg-yellow-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowluasBangunanLapangan}</Text></Text>
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>NJOP Bumi: <Text style={tailwind("bg-yellow-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowNJOPBumi}</Text></Text>
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>NJOP Bangunan : <Text style={tailwind("bg-yellow-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowNJOPBangunan}</Text></Text>
                                <Text style={{fontWeight:'bold',fontSize:14,marginLeft:12,marginTop:12,}}>Harga Transaksi : <Text style={tailwind("bg-yellow-200 rounded-full px-5 py-1 text-sm font-semibold text-gray-700 ")}>{ShowTransaksi}</Text></Text>
                            </View>
                        </View>
                        ...
                        <View style={{marginLeft:19,marginTop:13,marginRight:22,marginBottom:15,borderRadius:5,borderColor:'#F87171',borderWidth:2}}>
                            ...
                            <View style={{height:665,backgroundColor:'#FEE2E2'}}>
                                ...
                                <View style={{backgroundColor:'#FBBF24',width:280,marginTop:15,borderColor:'#FBBF24',borderWidth:2,borderRadius:5,marginLeft:18}}>
